            ...
            <nav class="dash-nav-list">
                ...
                <div class="dash-nav-dropdown">
                    ...
                    <div class="dash-nav-dropdown-menu">
                        <a href="{{url('/admin/product/create')}}" class="dash-nav-dropdown-item">Add New Products</a>
                    </div>
                    <div class="dash-nav-dropdown-menu">
                        <a href="{{route('product.index')}}" class="dash-nav-dropdown-item">List Products</a>
                    </div>
                </div>
                <div class="dash-nav-dropdown">
                    <a href="#!" class="dash-nav-item dash-nav-dropdown-toggle">
